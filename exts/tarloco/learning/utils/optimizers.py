# Copyright (c) 2025 University of Manchester, Amr Mousa
# SPDX-License-Identifier: CC-BY-SA-4.0
#
# This software is based in part on:
# AdaBelief Optimizer — https://github.com/juntang-zhuang/Adabelief-Optimizer
# © 2020 Juntang Zhuang and contributors
#
# Please cite the following work if you use or build on this implementation:
#
# @article{zhuang2020adabelief,
#   title={AdaBelief Optimizer: Adapting Stepsizes by the Belief in Observed Gradients},
#   author={Zhuang, Juntang and Tang, Tommy and Ding, Yifan and Tatikonda, Sekhar and
#           Dvornek, Nicha and Papademetris, Xenophon and Duncan, James},
